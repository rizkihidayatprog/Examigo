...
export const JENJANG_LIST: JenjangInfo[] = [
  { id: 'SD', name: 'Jenjang SD (Sekolah Dasar)', badge: 'SD', grades: ['SD 1', 'SD 2', 'SD 3', 'SD 4', 'SD 5', 'SD 6'] },
  { id: 'SMP', name: 'Jenjang SMP (Sekolah Menengah Pertama)', badge: 'SMP', grades: ['SMP 7', 'SMP 8', 'SMP 9'] },
  { id: 'SMA', name: 'Jenjang SMA (Sekolah Menengah Atas)', badge: 'SMA', grades: ['SMA 10', 'SMA 11', 'SMA 12'] },
  { id: 'SMK', name: 'Jenjang SMK (Sekolah Menengah Kejuruan)', badge: 'SMK', grades: ['SMK 10', 'SMK 11', 'SMK 12'] },
];
...
export function getAllCurriculumSubjects(): string[] {
  const set = new Set<string>();
  Object.values(CURRICULUM_SUBJECTS).forEach((list) => list.forEach((s) => set.add(s)));
