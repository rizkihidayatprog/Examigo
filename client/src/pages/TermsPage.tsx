      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8 animate-fade-in-fast">
        ...
        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6 text-xs text-slate-700 leading-relaxed font-medium">
          <section className="space-y-2">
            ...
            <p>
              Dengan mendaftar, mengakses, atau menggunakan layanan <strong>Examigo</strong>, Anda menyatakan telah membaca, memahami, dan menyetujui untuk terikat oleh Syarat dan Ketentuan ini. Layanan ini dirancang untuk memfasilitasi pembuatan soal berbasis AI, manajemen bank soal, serta pelaksanaan ujian online bagi pengajar dan lembaga pendidikan.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              Examigo menawarkan paket langganan bertingkat (Free, Personal, Pro AI). Pembayaran diproses secara aman melalui penyedia gerbang pembayaran terverifikasi (*Pakasir Payment Gateway*). Seluruh biaya langganan yang tercantum adalah dalam mata uang Rupiah (IDR).
            </p>
          </section>
