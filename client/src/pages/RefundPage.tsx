  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
      <SEO
        ...
        description="Pelajari ketentuan garansi 7 hari uang kembali 100% dan prosedur klaim pengembalian dana langganan di Examigo."
        canonical="https://examigo.id/refund"
      />
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8 animate-fade-in-fast">
        ...
        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6 text-xs text-slate-700 leading-relaxed font-medium">
          <section className="space-y-2">
            ...
            <p>
              Kami ingin Anda merasa yakin dengan investasi pendidikan Anda di Examigo. Oleh karena itu, kami memberikan **Garansi Uang Kembali 100% (7-Day Money-Back Guarantee)** untuk pembelian pertama paket langganan berbayar (Personal maupun Pro).
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              Setelah pengajuan disetujui, dana akan dikembalikan ke rekening atau dompet digital (*E-Wallet*) asal dalam waktu **3 hingga 5 hari kerja** sesuai ketentuan bank atau gerbang pembayaran Midtrans.
            </p>
          </section>
        </div>
      </div>
