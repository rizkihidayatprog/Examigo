    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8 animate-fade-in-fast">
        ...
        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6 text-xs text-slate-700 leading-relaxed font-medium">
          ...
          <section className="space-y-2">
            <h2 className="text-base font-extrabold text-slate-900">2. Pengolahan Data oleh AI Engine</h2>
            <p>
              Materi dokumen (PDF/DOCX/PPT) yang diunggah ke fitur **AI Generator** diproses secara aman menggunakan Google Gemini API via enkripsi HTTPS end-to-end. Teks dokumen Anda digunakan secara *transient* hanya untuk meracik butir soal dan tidak digunakan untuk melatih model AI publik secara eksternal.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              Examigo **tidak menjual** data pribadi Anda kepada pihak mana pun. Data hanya dibagikan kepada penyedia layanan terintegrasi yang tepercaya untuk operasional langsung: *Pakasir Payment Gateway* (untuk pemrosesan transaksi) dan penyedia SMTP email transaksional.
            </p>
          </section>
        </div>
      </div>
